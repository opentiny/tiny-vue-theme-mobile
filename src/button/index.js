export default {
  ...
  "tiny-mobile-button-bg-color-primary": "#4a79fe",
  "tiny-mobile-button-bg-color-success": "#52c41a",
  "tiny-mobile-button-bg-color-warning": "#faad14",
  "tiny-mobile-button-bg-color-danger": "#f04b3d",

...
export default {
  ...
  'tiny-base-color-primary-hover': '#40a9ff',
  ...
  'tiny-base-color-border': '#d9d9d9',
  'tiny-base-color-secondary': '#666',
  'tiny-base-color-placeholder': '#999',
  'tiny-base-color-hover-background': '#e6f7ff',
  'tiny-base-color-selected-background': '#f5f5f5',
  'tiny-base-color-navigation-background': '#2e3243',
  ...
  'tiny-base-size-width-medium': '120px',
